...
class CreditApi {
  ...
  private init() { }
  private  func fetchCredit<T>( data: Data, completion: @escaping (DCResult<T>) -> Void) {
    do {
  ...
  public func getCredit(completion: @escaping (DCResult<Credit>) -> Void) {
    request(completion: completion)
  }
  private func request <T> (completion: @escaping (DCResult<T>) -> Void) {
